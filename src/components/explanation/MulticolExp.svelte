...
<p>
    ...
    correlated. It can inflate the variance of the coefficient estimates,
    leading to less precise estimations.
</p>
<h7 class="text-blue-700">Variance Inflation Factor (VIF)</h7>
<p>
    The Variance Inflation Factor (VIF) measures how much the variance of the
    estimated regression coefficient increases if your predictors are
...
{#if !_.isUndefined(assumptionResult)}
    ...
    <p>
        {#if assumptionResult?.stats > 10}
            ...
            > exceeds 10. It is a sign of serious multicollinearity. It may inflate the variance of its coefficient estimate. You may want to consider changing the predictors in your model.
